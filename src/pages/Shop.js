...
import { fetchProductsByFilter, getProductsByCount } from "../actions/product";
    ...
    <div className="container mt-5">
      <div className="row">
        <div className="col-md-3 pt-2">
          <h4 className=" p-2 btn-light ">Search</h4>
          ...
          <Menu defaultOpenKeys={["1", "2", "3", "4"]} mode="inline">
            ...
            >
              <div
                ...
                className="pl-4 pr-4 text-danger "
              >
                {showSubs()}
              </div>
            </SubMenu>
        ...
        <div className="col-md-9 pt-2">
          {loading ? (
            ...
            <h4 className="text-center p-2  btn-light ">Product</h4>
          )}
